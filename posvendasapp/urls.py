...
urlpatterns = [
    ...
    path('tabela_venda/<int:pk>/editar/<int:produto_pk>/deletar', views.Deletar_Produto.as_view(),
         name='deletar_produto_via_venda'),
    path('tabela_venda/<int:pk>/editar/<int:ocorrencia_pk>/deletar_ocorrencia', views.DeleteOcorrencia.as_view(),
